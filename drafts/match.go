...
// Query matching: a query folds to lowercase terms, and text matches when it
// contains every one of them. There is no index — a drafts directory is small,
// and reading it is cheaper than keeping anything about it up to date.
